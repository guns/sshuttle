...
pkgver=
pkgrel=1
pkgdesc="Transparent proxy server that works as a poor man's VPN. Personal fork of original apenwarr trunk."
arch=('any')
url="https://github.com/guns/sshuttle"
license=('GPL2')
depends=('python2' 'iptables' 'openssh' 'net-tools' 'python2-setproctitle')
